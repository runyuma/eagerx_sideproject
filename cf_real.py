...
sensors = ["pos", "orientation","u_applied", ]
...
if __name__ == '__main__':
    ...
    # test_env.close()
    ##################
    model = sb3.SAC("MlpPolicy", test_env, verbose=1, learning_rate=7e-4, gamma=0.98,tensorboard_log="./sac_cf/")
    import helper
    sac_model = sb3.SAC.load("./sac_cf.zip")
    helper.evaluate_real(sac_model,test_env,n_eval_episodes=2,episode_length=1200, video_rate=rate,video_prefix="cf")